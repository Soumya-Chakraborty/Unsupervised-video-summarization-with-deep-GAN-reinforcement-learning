...
# Dataset options
parser.add_argument('-d', '--datasets', type=str, required=True, help="path to h5 dataset (required)")
...
def main():
    ...
    print("Initialize dataset {}".format(args.datasets))
    dataset = h5py.File(args.datasets, 'r')
